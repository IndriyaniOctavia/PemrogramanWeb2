...
<body style='background-color:	#F0F8FF'>
	...
	<div class="panel-heading">
		<center><h3 class="panel-title">Buku Tamu</h3><center>
	</div>
...
<?php
	...
	?>
        ...
        <table class="table" cellpadding="0" cellspacing="1" bgcolor="#B2E9FB">
            <tr>
                <td align="center" valign="middle" bgcolor="#F6FCFF"><strong>Sukses!</strong> Anda telah mengisi Buku Tamu </td>
            </tr>
            <tr>
	...
	<center>
        <table height="219" class="tg">
			...
			<tr>
				...
				<td><input  name="email" class="form-control" type="text" placeholder="E-mail" id="email" required/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input name="Reset" type="reset" class="btn btn-xs btn-danger" value="Reset">
				</td>
			</tr>
		</table>
		</center>
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">Daftar Buku Tamu</h3>
	</div>
	<div class="panel-body">
<!-- KODING KE 4 -->
<?php		
			...
			<tr>
				<td height="47" align="center">
					<table width="431" border="0" cellpadding="2" cellspacing="0">
						<tr>
							<td><b style="color:#696969"><?=$gede=strtoupper($bukutm['nama'])?></b><br>
							<font style="font-size:15px; color:#999999; "><?=$bukutm['tanggal']?> | <?=$bukutm['waktu']?></font>
							</td>
						</tr>
						<tr>
							<td><font style="font-size:15px; "><?=$bukutm['no_hp']?> </font></td>
						</tr>
						<tr>
